...
export const HERO_CONTENT = `I'm a B.Tech student at IGDTUW, deeply passionate about creating impactful tech solutions. From building deep learning models at DRDO to crafting responsive and animated web apps using React, I enjoy bridging logic with creativity. Currently, I'm diving into full stack development while mentoring peers in C++ and DSA. My journey includes leading the IEEE web team and designing AR lenses with 10K+ views. I'm driven by AI, embedded systems, and real-world innovation — always building, always evolving.`;
