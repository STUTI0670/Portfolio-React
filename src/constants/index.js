...
export const HERO_CONTENT = `I'm a B.Tech student at IGDTUW, passionate about turning ideas into meaningful tech solutions. From building deep learning models at DRDO to developing responsive and animated web apps with React, I enjoy blending technical depth with creativity. I'm currently exploring full stack development while actively mentoring peers in C++ and DSA. I’ve led web initiatives at IEEE, designed AR lenses with 10K+ views, and thrive in collaborative spaces where problem-solving, empathy, and learning go hand in hand. I believe great tech is built with both logic and heart — and I'm always excited to grow, build, and contribute.`;
